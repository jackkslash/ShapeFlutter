  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        colorScheme:
            ColorScheme.fromSeed(seedColor: Color.fromARGB(255, 194, 59, 59)),
        useMaterial3: true,
      ),
      home: const MyHomePage(title: 'Cocktail Generator'),
    );
  }
}
    ...
    setState(() {
      for (var eachDrink in jsonData['drinks']) {
        final cocktail = Cocktail(
            idDrink: eachDrink['idDrink'], drinkName: eachDrink['strDrink']);
        ...
        floatingActionButton: Row(
          ...
          children: [
            FloatingActionButton.large(
                ...
                child:
                    const Text("Random Cocktail", textAlign: TextAlign.center)),
            FloatingActionButton.large(
                onPressed: getCocktail,
                tooltip: 'More Info',
